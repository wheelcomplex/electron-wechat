# Electron-Lark
 ...
 ![release-download-count](https://img.shields.io/github/downloadswheelcomplex/electron-wechat/total.svg)

 ***下载地址: [Release](https://github.com/wheelcomplex/electron-wechat/releases)***
...
抄了 [ttys3](https://github.com/ttys3) 大佬的作业，感谢大佬！
 - 禁用硬件加速来修复 CPU 占用过高的问题 [issue12](https://github.com/wheelcomplex/electron-wechat/issues/12)
...
## 安装方法 (二进制安装)
 - 请从 [Release](https://github.com/wheelcomplex/electron-wechat/releases) 页面直接下载及安装 （ubuntu 18.04 上测试通过）
